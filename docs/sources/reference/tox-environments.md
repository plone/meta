...
myst:
  html_meta:
    "description": "Reference for tox environments generated by plone.meta"
    "property=og:description": "Reference for tox environments generated by plone.meta"
    "property=og:title": "tox Environments"
    "keywords": "plone.meta, tox, environments, testing"
---
...
plone.meta chooses the runner based on the `test_runner` option in
...
{file}`.meta.toml`.
See {doc}`/reference/meta-toml` for details.
