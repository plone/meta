...
Technical specifications, CLI details, and configuration option reference for plone.meta.
...
Description of each file that plone.meta generates, its source template, and its purpose.
:::
...
Reference for all tox environments generated by plone.meta and what each one does.
:::
...
Reusable GitHub Actions workflows and composite actions provided by plone/meta for Cookieplone projects.
:::
